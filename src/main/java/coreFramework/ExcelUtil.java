...
//			ExcelUtil datatable = null;
//			datatable = new ExcelUtil("C:\\99 Training\\workspaceluna\\SeFramework\\src\\test\\resources\\testData\\TestData.xlsx");
			
//			String outputExcel = getDataFromExcel("VerifyLogin4", "Password");
//			System.out.println(outputExcel);
	//
	//		//for (int row=0;row<datatable.getRowCount("Sheet1");row++) {
	//		for (int row=0;row<=4;row++) {
	//			for(int col=0 ;col< datatable.getColumnCount("Data"); col++)
	//				System.out.print(datatable.getCellData("Data", col, row)+"  ");
	//			System.out.println();
	//		}
			
//			datatable.getDataFromExcel("", "");
